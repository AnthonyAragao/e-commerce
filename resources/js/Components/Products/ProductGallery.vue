...
<template>
    <div class="flex gap-6">
        <div class="min-w-[600px] md:min-w-[400px]">
            <span
            ...
            <label
                for="file"
                class="text-center mt-1 flex flex-col items-center border-2 border-gray-200 border-dashed px-6 py-20 rounded-xl cursor-pointer dark:border-[#313442] shadow-sm"
            >
        ...
        <div class="flex flex-col w-full space-y-2 mt-4">
            <TransitionGroup name="fade" >
                ...
                >
                    ...
                    <div
                        class="w-10 h-8 bg-red-300/80 rounded-full flex items-center justify-center cursor-pointer shadow-md mt-2"
